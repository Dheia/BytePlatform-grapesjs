<div>
                    ...
                    <div class="btn-list">
                        @if (!$locked)
                            <a class="btn btn-primary d-none d-sm-inline-block"
                                byteplatform:modal="{{ route('admin.widget-setting') }}" byteplatform:modal-size="modal-lg"
                                byteplatform:modal-title="Setting Widget">
    ...
    <div class="page-body">
        <div class="container-fluid">
            <livewire:byteplatform::widget-list :$widgets :$locked wire:key='widget-{{ $widgetKey }}' />
        </div>
    </div>
</div>
