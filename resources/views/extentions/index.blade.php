                    ...
                    <div class="btn-list">
                        @if ($mode_dev)
                            <button class="btn btn-primary"
                                byteplatform:modal="{{ route('admin.create-extention', ['ExtentionType' => $ExtentionType]) }}"
                                byteplatform:modal-title="Create {{ page_title() }}">
                                Add New
                            </button>
                        @endif
                    </div>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    @livewire('byteplatform::extentions.' . $viewType, ['ExtentionType' => $ExtentionType], key($viewType . $__number_loading))
                </div>
            </div>
        </div>
    </div>
