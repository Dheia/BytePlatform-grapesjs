    ...
    <div class="card">
        <div class="card-body p-1">
            @if (!$locked)
                ...
                <span byteplatform:modal="{{ route('admin.widget-setting', ['widgetId' => $WidgetSetting['widgetId']]) }}"
                    byteplatform:modal-size="modal-lg" byteplatform:modal-title="Setting Widget" class="position-absolute"
