...
class BLinkCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $arr = [config('byteplatform.appdir.theme', 'themes'), config('byteplatform.appdir.module', 'modules'), config('byteplatform.appdir.plugin', 'plugins')];
        $root_path = config('byteplatform.appdir.root', 'byteplatform');
