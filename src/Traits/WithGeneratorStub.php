...
trait WithGeneratorStub
{
    ...
    public function getNamespaceReplacement()
    {
        if (!$this->_namespace) {
            ...
            if ($dataInfo) {
                ...
                $this->_namespace = config('byteplatform.namespace.root', config('byteplatform.appdir.root', 'byteplatform')) . '\\' . config('byteplatform.namespace.' . $this->getBaseTypeName(), config('byteplatform.appdir.' . $this->getBaseTypeName())) . "\\" . $this->getStudlyNameReplacement();
            }
        }
    ...
    {
        return config('byteplatform.composer.vendor');
    }
    /**
    ...
    {
        return config('byteplatform.composer.author.name');
    }
    /**
    ...
    {
        return config('byteplatform.composer.author.email');
    }
    /**
